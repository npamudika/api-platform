...
export const navigationRegistry: NavigationDefinition[] = [
  ...
  },
  {
    ...
    ...submenu([
      ...
      {
        // No GraphQL analog: a curl sample would just restate the console's
        // own fetcher.
        icon: <Terminal />,
        id: 'test-curl',
        label: 'Curl',
      ...
      {
        // No GraphQL analog: chatting against an API only makes sense for
        // REST's request/response shape, not a GraphQL schema.
        icon: <MessagesSquare />,
        id: 'test-chat',
        label: 'API Chat',
